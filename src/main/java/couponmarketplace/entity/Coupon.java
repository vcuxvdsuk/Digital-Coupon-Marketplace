...
public class Coupon extends Product {
    ...
    public BigDecimal getMinimumSellPrice() { return minimumSellPrice; }
    public void setMinimumSellPrice(BigDecimal minimumSellPrice) { this.minimumSellPrice = minimumSellPrice; }
